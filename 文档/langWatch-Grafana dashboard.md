...
> Importable Grafana dashboard JSON for the LangWatch AI Gateway — request rate, provider health, auth cache, budget, guardrail, streaming, and routing.
...
6. **Streaming** — active streams shows concurrency; fail-open rate is the stream\_chunk guardrail escape hatch firing (by design).
