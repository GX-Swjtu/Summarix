...
from app.chat.agent_factory import create_web_assistant
...
def create_runner(model_name: str, settings: Settings | None = None) -> Runner:
    settings = settings or get_settings()
    return Runner(
        agent=create_web_assistant(model_name),
